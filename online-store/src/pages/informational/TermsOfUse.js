...
const TermsOfUse = () => {
  return (
        <div>
            ...
            <div>
                <p>Настоящее Соглашение определяет условия использования Пользователями материалов и сервисов сайта www.rossko.ru (далее — «Сайт»).</p>
                <p>Основные понятия и определения:</p>
                <p>Сайт — совокупность размещенных в сети Интернет веб-страниц, объединенных единой темой, дизайном и единым адресным пространством.</p>
                <p>Пользователи — физические лица (в том числе представители юридических лиц), обладающие возможностью визуального ознакомления с размещенной на сайте информацией.</p>
                <p>Администрация Сайта — лица, уполномоченные Владельцем Сайта на осуществление управления Сайтом и иные действия, связанные с его использованием. Администрация Сайта действует от имени Владельца Сайта</p>
                <ol>
